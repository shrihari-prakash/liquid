...
* **Admin Controls:** With [Liquid Nitrogen](https://github.com/shrihari-prakash/nitrogen), you can spin up a powerful admin panel in minutes. But if you want to build your own admin panel, Liquid offers elevated administrative APIs that let you effectively manage users by editing profile information, banning and restricting accounts when necessary.
