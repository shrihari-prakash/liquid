...
4. Refer to [this section](/api-documentation/API-Documentation-OAuth-2.0#access-token-from-authorization-code) to see how your app exchanges `code` and `code_verifier` at `POST /oauth/token` for access tokens.
